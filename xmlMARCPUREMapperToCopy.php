...
<br>
    ...
    <p>&nbsp;&nbsp; Convert your INSPIRE-exported MARCXML to PURE XML here. Upload the MARCXML first, and then upload your "internal ID" file with the INSPIRE ID on the left, PURE ID on the right. Separate with a semi-colon.</p>
</div>
<div class = "box">

    <p><form action="xmlMARCPUREMapperToFile.php" method="post" enctype="multipart/form-data">
        &nbsp;&nbsp;Select XML file to upload:
        &nbsp;&nbsp;<input type="file" name="xmlfile" id="xmlfile">
        &nbsp;&nbsp;Select internal IDs file to upload:
...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["internalIDfile"]["tmp_name"], $target_id_file)) {
            echo "The file ". basename( $_FILES["internalIDfile"]["name"]). " has been uploaded.";
        } else {
