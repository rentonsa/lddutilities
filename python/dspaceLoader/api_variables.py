...
ALL_VARS = {
    ...
    'API_URL' : 'http://vernonapi.is.ed.ac.uk/vcms-api/oecgi4.exe/datafiles/OBJECT/?query=',
    ...
    'LIMIT' : '&limit=10000',
    'API_AV_CHECK_URL': 'http://vernonapi.is.ed.ac.uk/vcms-api/oecgi4.exe/datafiles/AV?query=',
    'ST_CECILIA_QUERY': 'slist:"StCeciliasItems")',
    'MIMED_QUERY' : 'squery:"MIMEdSkylight")',
    'GEOLOGY_QUERY' : 'squery:"GeologySkylight")',
    'PUBLIC_ART_QUERY': 'squery:"Public%20Art")',
    'ANATOMY_QUERY':'squery:"AnatomySkylight")',
