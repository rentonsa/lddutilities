...
if ./load_runner_api.sh art 10683/6 1 31
then
...
if ./load_runner_api.sh mimed 10683/14558 0 31
then
...
if ./load_runner_api.sh stcecilia 10683/95806 0 31
then
...
if ./load_runner_api.sh publicart 10683/102633 0 31
then
